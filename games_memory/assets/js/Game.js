class Game {
  constructor(contGame, level, prog, chor, speed, maxMilliseconds) {
    ...
    this.URL = "https://adso-new-default-rtdb.asia-southeast1.firebasedatabase.app/users.json";
